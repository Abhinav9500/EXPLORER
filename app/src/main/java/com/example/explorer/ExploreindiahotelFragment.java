...
public class ExploreindiahotelFragment extends Fragment {


    public ExploreindiahotelFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_exploreindiahotel, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        appCompatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), IndiahotelActivity.class);
        ...
        textView43.setText("The Oberoi Amarvilas..\nit is surrounded by greenery " +

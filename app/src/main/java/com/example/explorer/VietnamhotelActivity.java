...
public class VietnamhotelActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vietnamhotel);
        ...
        TextView continuebookvietnam=findViewById(R.id.continuebookvietnam);
        continuebookvietnam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(VietnamhotelActivity.this, "Redirecting to payment gateway-->", Toast.LENGTH_SHORT).show();

...
public class ExplorethailandhotelFragment extends Fragment {


    public ExplorethailandhotelFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_explorethailandhotel, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        appCompatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), ThailandhotelActivity.class);
        ...
        textView43.setText("Lanta Casa Blanca..\nit is surrounded by greenery " +
